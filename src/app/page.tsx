          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(500px, 1fr))", gap: "64px", alignItems: "center" }}>
            ...
            <div>
              ...
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "4px 12px", borderRadius: "9999px", background: "rgba(49,53,61,0.3)", border: "1px solid rgba(67,70,84,0.2)", marginBottom: "32px" }}>
                ...
                <span style={{ fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "#c3c6d6" }}>Base Sepolia Testnet</span>
              </div>
              ...
              <h1 style={{ fontFamily: "Manrope, sans-serif", fontSize: "56px", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.02em", color: "#e0e2ed", marginBottom: "24px" }}>
                Capital for builders, yield for everyone
              </h1>
              
              {/* Subheadline */}
              <p style={{ fontSize: "18px", lineHeight: "1.6", color: "#c3c6d6", maxWidth: "540px", marginBottom: "40px" }}>
                The fixed-income protocol on Base. Tokenized bonds, predictable USDC yield, institutional liquidity.
              </p>
                ...
                <div style={{ background: "rgba(24,28,35,0.6)", backdropFilter: "blur(20px)", padding: "24px", borderRadius: "12px", border: "1px solid rgba(67,70,84,0.1)", boxShadow: "0 20px 60px rgba(0,0,0,0.4)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      <div>
                        <div style={{ fontSize: "13px", fontWeight: 700, fontFamily: "Manrope, sans-serif", color: "#e0e2ed" }}>Sparrow Protocol Demo</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  ...
                  <div style={{ background: "#0a0e16", padding: "20px", borderRadius: "12px", border: "1px solid rgba(67,70,84,0.1)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                      ...
                      <span style={{ fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.15em", color: "#c3c6d6", fontWeight: 600 }}>Base Sepolia</span>
                    </div>
      ...
      <section style={{ padding: "128px 32px", background: "#10131b" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <div style={{ marginBottom: "64px" }}>
            <h2 style={{ fontFamily: "Manrope, sans-serif", fontSize: "32px", fontWeight: 700, marginBottom: "16px", letterSpacing: "-0.01em", color: "#e0e2ed" }}>How Sparrow Works</h2>
            <p style={{ fontSize: "16px", color: "#c3c6d6", maxWidth: "640px" }}>A simple, transparent protocol for tokenized bond issuance and peer-to-peer trading on Base.</p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "24px", minHeight: "600px" }}>
            ...
            >
              <div style={{ position: "relative", zIndex: 10 }}>
                ...
                <h3 style={{ fontFamily: "Manrope, sans-serif", fontSize: "24px", fontWeight: 700, marginBottom: "16px", color: "#e0e2ed" }}>Tokenized Bond Issuance</h3>
                <p style={{ fontSize: "14px", color: "#c3c6d6", maxWidth: "420px", lineHeight: "1.6" }}>Any company can raise debt capital by issuing ERC-20 bond tokens on Base. Set your own terms — APY, maturity, and issue size.</p>
              </div>
            ...
            >
              <div>
                ...
                <h3 style={{ fontFamily: "Manrope, sans-serif", fontSize: "20px", fontWeight: 700, marginBottom: "12px", color: "#e0e2ed" }}>Fixed USDC Yield</h3>
                <p style={{ fontSize: "13px", color: "#c3c6d6", lineHeight: "1.5" }}>Investors earn predictable USDC yield, distributed on-chain via checkpoint-based accounting.</p>
              </div>
            </div>
            ...
            >
              ...
              <h3 style={{ fontFamily: "Manrope, sans-serif", fontSize: "20px", fontWeight: 700, marginBottom: "12px", color: "#e0e2ed" }}>Escrow-Protected Trading</h3>
              <p style={{ fontSize: "13px", color: "#c3c6d6", lineHeight: "1.5" }}>All secondary market trades are settled through BondEscrow smart contract. Bonds lock on listing, transfer atomically on purchase.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div style={{ background: "#1c2027", borderRadius: "32px", padding: "80px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 10, maxWidth: "640px" }}>
              ...
              <p style={{ fontSize: "18px", lineHeight: "1.6", color: "#c3c6d6", marginBottom: "48px" }}>
                Built on Base. Open to everyone.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
                <Link
                  href="/launchpad"
